...
robot = Object("iai_donbot", "robot", "iai_donbot.urdf", pose=Pose([1, 2, 0]))
...
with simulated_robot:
    ...
    # pose = robot.get_link_pose("gripper_tool_frame")
    # marker.publish(pose, name="gripper_tool_frame")
    ...
    NavigateAction([Pose([1.5, 2.15, 0], [0, 0, 1, 1])]).resolve().perform()
    ...
    PickUpAction.Action(milk_desig, "left", "top").perform()
    ...
    NavigateAction([Pose([4.1, 4.2, 0], [0, 0, 1, 1])]).resolve().perform()
