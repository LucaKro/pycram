...
objects = [(None, None), ('apple', "obo:FOODON_03301710"),
           ('avocado', "obo:FOODON_00003600"), ('banana', "obo:FOODON_00004183"),
...
def start_demo():
    ...
    Object("rollin-justin", ObjectType.ROBOT, "rollin-justin.urdf", pose=Pose([1, 2, 0]))
